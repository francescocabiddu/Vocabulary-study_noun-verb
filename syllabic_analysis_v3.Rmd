---
title: 'Paper 1: results (syllabic analysis, v3)'
output:
  word_document:
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
tests <- list(t.test(summary_freq_sets$Mono_learned_freq[1:12],
                     summary_freq_sets$Mono_not_learned_freq[1:12],
                     paired = TRUE),
              t.test(summary_freq_sets$Bis_learned_freq[1:12],
                     summary_freq_sets$Bis_not_learned_freq[1:12],
                     paired = TRUE),
              t.test(summary_freq_sets$Tri_learned_freq[1:12],
                     summary_freq_sets$Tri_not_learned_freq[1:12],
                     paired = TRUE))
